...
// Rates are negotiated per booking, so the cards carry the vehicle on offer
// instead of a figure. Images are the current fleet (6 / 10 / 14 / 28 seater).
const highlightTransfers = [
  ...
  { from: "Airport / Ferry", to: "Paje", vehicle: "Toyota Hiace · up to 14 seats", image: "/images/vehicles/hiace-14-seater.jpeg" },
  { from: "Airport / Ferry", to: "Matemwe", vehicle: "Toyota Coaster · up to 28 seats", image: "/images/vehicles/coaster-28-seater.jpeg" },
  { from: "Airport / Ferry", to: "Jambiani", vehicle: "Toyota Alphard · up to 6 seats", image: "/images/vehicles/alphard-6-seater.jpeg" },
  { from: "Airport / Ferry", to: "Kiwengwa", vehicle: "Toyota Hiace · up to 14 seats", image: "/images/vehicles/hiace-14-seater.jpeg" },
]
...
export default function HomePageClient() {
  ...
  const waterSports = [
    { name: "Jet Ski Adventure", img: "/water-sports-images/jet-ski-adventure.jpeg", desc: "Feel the pure adrenaline rush as you race across the crystal-clear turquoise waters of Zanzibar! Our powerful jet skis deliver an unforgettable thrill with breathtaking coastal views and ocean spray." },
    ...
    { name: "Mangrove Kayaking", img: "/water-sports-images/mangrove-kayaking.jpeg", desc: "Glide through Zanzibar's tranquil mangrove channels, drifting under a canopy of tangled roots alive with kingfishers and crabs. A calm, shaded paddle that's perfect for families and nature lovers." },
  ...
  const carHire = [
    { name: "Toyota Alphard", img: "/images/vehicles/alphard-6-seater.jpeg", desc: "Travel in executive comfort with our premium Toyota Alphard. This luxury van offers plush leather seating, extra legroom, and a smooth ride — perfect for families and VIP transfers who demand the best.", seats: "Up to 6 seats" },
    { name: "Toyota Hiace", img: "/images/vehicles/hiace-10-seater.jpeg", desc: "Roomy and dependable, our 10-seater Hiace is the easy answer for small groups travelling together. Air-conditioned throughout with plenty of room for luggage on longer island runs.", seats: "Up to 10 seats" },
    { name: "Toyota Hiace Commuter", img: "/images/vehicles/hiace-14-seater.jpeg", desc: "The 14-seater Commuter keeps larger families and friend groups in one vehicle. High roof, comfortable seating and generous luggage space for airport runs and full-day excursions.", seats: "Up to 14 seats" },
    { name: "Toyota Coaster", img: "/images/vehicles/coaster-28-seater.jpeg", desc: "Spacious, comfortable, and perfect for large groups. Our Toyota Coaster seats up to 28 passengers with air conditioning and ample luggage space — ideal for group tours, events, and corporate travel across Zanzibar.", seats: "Up to 28 seats" },
  ]
  const drivers = [
      ...
      <section className="py-12 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-14 animate-on-scroll fade-up">
            ...
            <div className="zn-rule" aria-hidden="true" />
            <p className="text-slate-ink text-sm sm:text-base mt-4 max-w-2xl mx-auto">Reliable, comfortable transfers across Zanzibar Island with professional drivers and a modern 6, 10, 14 and 28-seater fleet. Message us and we will agree your rate before you travel.</p>
          </div>
            ...
            {highlightTransfers.map((route, i) => (
              <div key={i} className="animate-on-scroll fade-up group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-border hover:-translate-y-1" data-delay={i * 100}>
                ...
                <div className="p-4 flex items-center justify-between gap-3">
                  <div>
                    <p className="text-sm font-extrabold text-ocean">Price on request</p>
                    <p className="text-slate-ink/75 text-xs">{route.vehicle}</p>
                  </div>
      ...
      <section className="py-12 sm:py-20 bg-mist">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-14 animate-on-scroll fade-up">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-extrabold text-ink">
              Car <span className="text-sea italic">Hire</span> &amp; Rental Fleet
            </h2>
            <div className="zn-rule" aria-hidden="true" />
            <p className="text-slate-ink text-sm sm:text-base mt-4 max-w-2xl mx-auto">Explore Zanzibar at your own pace with our well-maintained, air-conditioned rental fleet. From an executive Alphard to a 28-seater Coaster — we have the right vehicle for every group. Daily rates are agreed with you when you book.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {carHire.map((car, i) => (
              <div key={i} className="animate-on-scroll fade-up bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden hover:-translate-y-1 flex flex-col" data-delay={((i % 4) * 100).toString()}>
                <div className="relative p-4 pb-0">
                  <div className="relative h-44 sm:h-48 rounded-xl overflow-hidden bg-mist">
                    <Image src={car.img} alt={car.name} fill className="object-contain" sizes="(max-width:640px)100vw,(max-width:1024px)50vw,25vw" />
                  </div>
                </div>
