...
export const metadata: Metadata = {
  ...
  description:
    "The classic island week in miniature — history, spice farms, sandbanks and reef snorkelling. 4 nights in Zanzibar, including accommodation, breakfast & dinner, transfers and guided excursions.",
  keywords: [
...
export default function Zanzibar5DaysPackage() {
  return (
    <>
      <Navigation />
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="relative h-[60vh] min-h-[500px]">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/3-pkDJR7WXf4YSlGOacUsAnIpo2RGvl7.jpg"
            alt="Cave Swimming Pool in Zanzibar"
            fill
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="container mx-auto px-4 pb-16">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
                Zanzibar 5 Days 4 Nights Package
              </h1>
      ...
      <section className="py-12 sm:py-20 bg-ocean text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg sm:text-xl mb-8 leading-relaxed">
            Book your 5-day Zanzibar package today and experience the best of this tropical paradise. 
