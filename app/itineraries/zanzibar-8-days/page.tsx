...
export const metadata: Metadata = {
  ...
  description:
    "Eight days across the whole island, from UNESCO Stone Town to Mnemba's coral gardens. 7 nights in Zanzibar from $1,340 per person, including accommodation, breakfast & dinner, transfers and guided excursions.",
  keywords: [
    "Zanzibar 8 days package",
    "Zanzibar 7 nights holiday",
  ...
  openGraph: {
    title: "Zanzibar 8 Days 7 Nights Package | Zanzione Tours & Safaris",
    description:
      "Eight days across the whole island, from UNESCO Stone Town to Mnemba's coral gardens. 7 nights in Zanzibar from $1,340 per person, including accommodation, breakfast & dinner, transfers and guided excursions.",
    url: "https://www.zanzionetours.com/itineraries/zanzibar-8-days",
    images: [
      {
        url: "/new-zanzi-tours-images/nakupenda-island.jpeg",
        width: 1200,
        height: 630,
        alt: "Zanzibar 8 Days 7 Nights Package — turquoise water and white sand in Zanzibar",
      },
    ],
  },
  alternates: {
    canonical: "https://www.zanzionetours.com/itineraries/zanzibar-8-days",
  },
}
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    {/* Day 3 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 3: Half day Jozani Forest Tour</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 4 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 4: Tour – Spice Farm, Prison Island & Stone Town</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 5 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 5: Pick up to your next Hotel in Nungwi Beach</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 6 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 6: Chilling day!</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 7 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 7: Half Day – Mnemba Dolphins & Snorkeling</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 8 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 8: Transfer to the Airport, Goodbye!</h3>
                      <div className="space-y-2 text-ink/85">
