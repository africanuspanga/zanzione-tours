    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Zanzibar 9 Days 8 Nights Package — turquoise water and white sand in Zanzibar",
      },
    ],
  },
  alternates: {
    canonical: "https://www.zanzionetours.com/itineraries/zanzibar-9-days",
  },
}
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    {/* Day 4 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 4: Full day Spice Farm, Prison Island & Stone Town</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 5 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 5: Pick up to next Hotel in Nungwi Beach + Jozani Forest</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 6 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 6: Relaxing Day</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 8 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 8: Half Day – Mnemba Dolphins & Snorkeling</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 9 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 9: Transfer to the Airport, Goodbye!</h3>
                      <div className="space-y-2 text-ink/85">
