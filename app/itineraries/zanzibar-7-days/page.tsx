...
export const metadata: Metadata = {
  ...
  description:
    "A full week covering Stone Town, Safari Blue, Jozani Forest and the northern beaches. 6 nights in Zanzibar from $1,298 per person, including accommodation, breakfast & dinner, transfers and guided excursions.",
  keywords: [
    "Zanzibar 7 days package",
    "Zanzibar 6 nights holiday",
  ...
  openGraph: {
    title: "Zanzibar 7 Days 6 Nights Package | Zanzione Tours & Safaris",
    description:
      "A full week covering Stone Town, Safari Blue, Jozani Forest and the northern beaches. 6 nights in Zanzibar from $1,298 per person, including accommodation, breakfast & dinner, transfers and guided excursions.",
    url: "https://www.zanzionetours.com/itineraries/zanzibar-7-days",
    images: [
      {
        url: "/new-zanzi-tours-images/nakupenda-island.jpeg",
        width: 1200,
        height: 630,
        alt: "Zanzibar 7 Days 6 Nights Package — turquoise water and white sand in Zanzibar",
      },
    ],
  },
  alternates: {
    canonical: "https://www.zanzionetours.com/itineraries/zanzibar-7-days",
  },
}
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    {/* Day 3 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 3: Beach Relaxing!</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 5 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 5: Half Day – Mnemba Dolphins & Snorkeling</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 6 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 6: Half day – Jozani forest & the Rock</h3>
                      <div className="space-y-2 text-ink/85">
                    ...
                    {/* Day 7 */}
                    <div className="border-l-4 border-aqua pl-6 py-2">
                      <h3 className="text-xl font-bold text-ink mb-2">DAY 7: Transfer to the Airport, Goodbye!</h3>
                      <div className="space-y-2 text-ink/85">
              ...
              <div className="sticky top-24 space-y-6">
                ...
                <Card className="border-2 border-ocean">
                  <CardContent className="p-6">
                    ...
                    <BookingModal 
                      tourName="Zanzibar 7 Days 6 Nights Package" 
